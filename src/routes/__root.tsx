...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hasira Nenuka — Aspiring Software Developer" },
      ...
      { property: "og:title", content: "Hasira Nenuka — Aspiring Software Developer" },
      { name: "twitter:title", content: "Hasira Nenuka — Aspiring Software Developer" },
      { property: "og:description", content: "Portfolio of Hasira Nenuka, Information Technology Undergraduate and full-stack developer." },
      { name: "twitter:description", content: "Portfolio of Hasira Nenuka, Information Technology Undergraduate and full-stack developer." },
